...
//downloadUtils.downloadApk(versionEntity.apkul, "mobilecuard.apk", context);
    ...
    protected void downLoadNewApk(String apkul) {
        DownloadUtils downloadUtils = new DownloadUtils();
        downloadUtils.downloadApk(apkul, "/mnt/sdcard/mobilesafe2.0apk", new MyUtils() {
            @Override
            public void onSuccess(ResolveInfo arg0) {

            }

            @Override
            public void onSuccess(ResolveInfo<File> arg0) {
            ...
            @Override
            public void onFailure(HttpRetryException arg0, String arg1) {
